...
EN_REPLACEMENTS = [
    ...
    (r"\bmarg\b", "margarine"),
    (r"\bbev\b", "beverage"),
    (r"\bli\s+co\b", "liquid concentrate"),
    (r"\bliq\s+co\b", "liquid concentrate"),
    (r"\bready\s+to\s+fe\b", "ready-to-feed"),
    (r"\brdy\s+to\s+fe\b", "ready-to-feed"),
    (r"\bflt-o-fsh\b", "Filet-O-Fish"),
    (r"\bform wyeth-ayerst\b", "from Wyeth-Ayerst"),
    (r"\bstd\b", "standard"),
...
SK_REPLACEMENTS = [
    ...
    (r"\bchs\b", "syr"),
    (r"\bchk\b", "podplece"),
    (r"\bprep\b", "pripravené"),
    (r"\blt\b", "ľahké"),
    (r"\bmxd\b", "zmiešané"),
    (r"\bsprd\b", "nátierka"),
    (r"\blofat\b", "nízkotučný"),
    (r"\bhvy\b", "hustý"),
    (r"\bhwy\b", "hustý"),
    (r"\bmarg\b", "margarín"),
    (r"\bswtnd\b", "sladené"),
    ...
    (r"\bsp\b", "druhy"),
    (r"\bbev\b", "nápoj"),
    (r"\bli\s+co\b", "tekutý koncentrát"),
    (r"\bliq\s+co\b", "tekutý koncentrát"),
    (r"\bready\s+to\s+fe\b", "pripravená na kŕmenie"),
    (r"\brdy\s+to\s+fe\b", "pripravená na kŕmenie"),
    (r"\bflt-o-fsh\b", "Filet-O-Fish"),
    (r"\bchoc\b", "čokoládový"),
    (r"\bform wyeth-ayerst\b", "od Wyeth-Ayerst"),
    (r"\bstd\b", "štandardný"),
    (r"\bappl\b", "jablkový"),
    (r"\bdssrt\b", "dezert"),
    (r"\bjr\b", "junior"),
    (r"\bnot\s+recon\b", "nepripravené"),
    (r"\bnon\s+rekon\b", "nepripravené"),
    (r"\bbrkfst\b", "raňajkový"),
    (r"\bcukor-free\b", "bez cukru"),
    (r"\btstr\s+pstrs\b", "pečivo do hriankovača"),
    (r"\bfrt\b", "ovocné"),
    (r"\btstd\b", "opekané"),
    (r"\bcond\b", "kondenzované"),
    (r"\btekutina\s+co\b", "tekutý koncentrát"),
